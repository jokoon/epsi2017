...
<body>
    ...
    <div class="pres_jeux">
        <div id="form01">
            ...
            ?>
<!--              <form method="POST">
                 <input class="field01" name="login" type="text" placeholder="Enter your login"><br/>
                 <input class="field01" name="password" type="password" placeholder="Enter your password"><br/>
